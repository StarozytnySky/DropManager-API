...
/**
 * PlayerCloseMenuDropEvent is a custom Bukkit event that is called when a player close menu with drops.
 */
public class PlayerCloseMenuDropEvent extends Event implements Cancellable {
	 ...
	 */
	public PlayerCloseMenuDropEvent(Player player, Inventory inventory) {
		this.player = player;
